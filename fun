...
%spessore_trappole=spessore_organico/10; %(2 punti di mesh in z)
%nodi_trappole=find(semicond.p(3,:)>=spessore_ossido & semicond.p(3,:)<=spessore_ossido+spessore_trappole);
